...
function assertprogram(name, opcodes, input, expectedoutput) {
    var memory = new ProgramMemory(opcodes);

    var disasm = new Disassembler(memory, name);
    disasm.print();

    var reader = new ProgramReader(memory);
    reader.seek(0);

    var runtime = new Runtime(reader, name);
    runtime.verbose = true;
    while (!runtime.halted) {
        runtime.step();
    }

    var actual = runtime.programoutput.join(',');
...
// assertprogram('Small', '109,2000,109,19,204,-34', '', '1985');
// assertprogram('Quine', '109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99', '', '109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99');
// assertprogram('16-Digit', '1102,34915192,34915192,7,4,7,99,0', '', '1219070632396864');
// assertprogram('Large-number', '104,1125899906842624,99', '', '1125899906842624');

function disassembleprogram(name, opcodes) {
    var memory = new ProgramMemory(opcodes);

    var program = new Disassembler(memory, name);
    program.print();
...
// disassembleprogram('I/O', '3,0,4,0,99');
// disassembleprogram('Quine', '109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99');
// disassembleprogram('16-Digit', '1102,34915192,34915192,7,4,7,99,0');
// disassembleprogram('Large-number', '104,1125899906842624,99');
